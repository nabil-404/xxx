...
def main():
	...
	print W+R+ "NOTE:"+C+"Awal Gozina A ra entekhab konid wa facebook Khoda Baz konid" 
	...
	Buy 50k This Tool Contact Me FACEBOOK rafi.569
		"""
		raw_input( W+"[!]"+R+" Press enter to menu ...")
		os.system('clear')
		main()
